import { getWritingSurvey } from "@features/mysurvey/service/mysurvey/api";
import type { WritingSurveyResult } from "@features/mysurvey/service/mysurvey/types";
import { useMultiStep } from "@shared/contexts/MultiStepContext";
import { useSurvey } from "@shared/contexts/SurveyContext";
import { convertWritingQuestionsToQuestions } from "@shared/lib/writingQuestionConverter";
import { useToast } from "@toss/tds-mobile";
import { useNavigate } from "react-router-dom";
import type { DraftSurvey } from "../components/types";
